...
public enum Lang {
  ...
  ROSTERS_HELP("rosters.help", String.join(System.lineSeparator(),
      "&a&lTimovi&8&l» &fLista dostupnih &b/rosters&f komandi:",
      "&b/rosters|rt list [liga]: &fPrikaz svih timova (ili po ligi).",
      "&b/rosters|rt info|view [imeTima]: &fPrikaz informacija o timu.",
      "&b/rosters|rt switch|setleague <liga>: &fPostavljanje aktivne lige.",
      "&b/rosters|rt create <imeTima> <tagTima> <liga>: &fPravljenje novog tima u ligi.",
      "&b/rosters|rt delete <imeTima>: &fBrisanje tima.",
      "&b/rosters|rt add <imeTima> <imeIgrača>: &fDodavanje igrača u tim.",
      "&b/rosters|rt remove <imeIgrača> <liga>: &fBrisanje igrača iz tima u datoj ligi.",
      "&b/rosters|rt manager <imeIgrača> <liga>: &fPostavljanje menadžera tima.",
      "&b/rosters|rt name <imeTima> <noviNaziv>: &fPodešavanje punog naziva tima.",
      "&b/rosters|rt tag <imeTima> <noviTag>: &fPodešavanje taga tima (sa bojama).",
      "&b/rosters|rt league <imeTima> <novaLiga>: &fPrebacivanje tima u drugu ligu.",
      "&b/rosters|rt addleague <liga>: &fDodavanje nove lige.",
      "&b/rosters|rt removeleague <liga>: &fUklanjanje lige.",
      "&b/rosters|rt renameleague <staraLiga> <novaLiga>: &fPreimenovanje lige.",
      "&b/rosters|rt reload: &fPonovno učitavanje konfiguracije.",
      "&r",
      "&eLeagues: &7{0} &8| &eActive: &a{1}"
  )),
  ...
  ROSTERS_CREATE("rosters.create", "{prefix}Tim &e\"{0}\"&f sa tagom {1}&f je uspešno napravljen za ligu {2}!"),
  ...
  ROSTERS_REMOVE("rosters.remove", "{prefix}Igrač &b{0} &fje izbačen iz svog {1} tima!"),
  ROSTERS_INFO_HEADER("rosters.info.header", String.join(System.lineSeparator(),
      "&e-------------[ &6&l{0} Roster &e]----------------",
      "&r &r",
      "&7   Učestvuje u &f{1} &7ligi.",
      "&7   Broj članova: &f{2}",
      "&7   {3} {4}",
      "&r &r",
      "&e   &lLista igrača:")),
  ROSTERS_INFO_PLAYER_ENTRY("rosters.info.player-entry", "&6    {0} {1}"),
  ROSTERS_INFO_FOOTER("rosters.info.footer", String.join(System.lineSeparator(),
      "&r &r",
      "&e---------------------------------------------")),
  ROSTERS_INFO_MANAGER_DISPLAY("rosters.info.manager", "&7 menadžer &f{0}"),
  ROSTERS_LIST_HEADER("rosters.list.header", String.join(System.lineSeparator(),
      "&e------------[ &6&lRosters {0} &e]---------------",
      "&r &r")),
  ROSTERS_LIST_ENTRY("rosters.list.entry", "&r    {0} &7(&o{1} - {2} igrača){3}"),
  ROSTERS_LIST_LEAGUE_ENTRY("rosters.list.league-entry", "&f   &l{0} timovi:"),
  ROSTERS_USAGE("rosters.usage", "{prefix}&cPogrešna upotreba. Koristi &e/rosters help"),
  ...
  YES("yes", "&aDA"),
  NO("no", "&cNE"),
  NO_PERM_SHORT("no-perm-short", "&7 (&onemate dozvolu&7)"),
  UNDEFINED("undefined", "&cNEDEFINISAN");
